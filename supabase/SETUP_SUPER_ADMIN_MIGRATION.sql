-- ============================================================================
-- APPBENK: SETUP SUPER ADMIN & PLATFORM SYSTEM
...
SELECT 'SETUP SUPER ADMIN & CS BERHASIL' AS status;

-- ============================================================================
-- CARA MENETAPKAN AKUN SUPER ADMIN:
-- Buka Supabase SQL Editor dan jalankan:
--
-- UPDATE public.profiles
-- SET role = 'super_admin'
-- WHERE email = 'EMAIL_SUPER_ADMIN_ANDA@gmail.com';
--
-- UPDATE auth.users
